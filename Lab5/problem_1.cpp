 ...
 * Description: This program uses the getText() function to check the following conditions:
 *      1. Total words in the given text.
 *      2. Total letters in the given text not including punctuation and spaces.
 *      3. On what line does the text “star-crossed lovers” appear?
 *      4. What is the average word length in the text?
 *      5. What is the longest word in the text?
 */
...
int main() {
    ...
    for (int i = 0; i < myText.size(); i++){
        ...
        if (myText[i].find("star-crossed lovers") < myText[i].size()) {
